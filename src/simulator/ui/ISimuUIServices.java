 ...
 *
 */
public interface ISimuUIServices {
    Ram getRamComponent();
    Aleph8 getCpuComponent();
    HexFile getHexFile();
    ExeFunc cmdeSimu();
    short getUiState();
    void setUIState(short newState);
    ButtonsPanel getButtonsCmdes();
    Frame getMainFrame();
    Dimension getFrameDim();
    void resetUI(String fileName);
    ShowAleph8 getUICpu();
    MemoryView getUIMemory();
